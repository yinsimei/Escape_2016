...
public class ReadableObject : RaycastReceiver
{
    ...
    public string dialogueAfterReading;
    ...
    private IEnumerator WaitForDocEnd()
    {
        ...
        // Play Dialogue After Reading
        if (!string.IsNullOrEmpty(dialogueAfterReading))
        {
            DialogueManager.StartConversation(dialogueAfterReading);
        }
    }
}